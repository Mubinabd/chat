...
import (
	...
	t "github.com/Mubinabd/chat/internal/delivery/token"
...
// @Produce json
// @Security BearerAuth
// @Param profile body auth.EditProfileReqBody true "Updated profile details"
...
func (h *Handlers) EditProfile(c *gin.Context) {
	...
	var body auth.EditProfileReqBody
